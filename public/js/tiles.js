...
const Tiles = () => {
    ...
    return (
    // @ts-ignore
    React.createElement(Globe, { tilesData: tilesData, tileHeight: "height", tileWidth: "width", tileAltitude: (d) => (d === hoverD ? 0.02 : 0.01), onTileClick: setHoverD, tileMaterial: mtr, animateIn: false }));
};
