...
class Points extends THREE.Group {
    ...
    loadPoints() {
        const ratio = this.radius / 450, dots = 10000, radius = this.radius, geometry = new THREE.PlaneGeometry(10 * ratio, 10 * ratio), dotGeo = new THREE.BufferGeometry(), positions = [], rndIds = [], tilesIds = [], vector = new THREE.Vector3();
